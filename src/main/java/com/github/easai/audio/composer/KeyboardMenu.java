...
public class KeyboardMenu {
	...
	static String menus[] = { "File", "Play", "Help" };
	String menuitems[][] = { { "Open", "Save", "SaveAs", "Quit" }, { "Test" }, { "About" } };

	enum MENUITEM {
		nFileOpen, nFileSave, nFileSaveAs, nFileQuit, nPlayTest, nHelpAbout
	};

	MENUITEM mi_num[][] = { { MENUITEM.nFileOpen, MENUITEM.nFileSave, MENUITEM.nFileSaveAs, MENUITEM.nFileQuit },
			{ MENUITEM.nPlayTest }, { MENUITEM.nHelpAbout } };
